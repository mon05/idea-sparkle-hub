...
export const translations = {
  ...
  ka: {
    ...
    heroDescription: "პროფესიონალური გამოთვლები მჟავების დამატებისთვის, დამწმენდი აგენტებისთვის, გოგირდის მართვისთვის და სხვა.",
    ...
    categories: {
      acids: {
        name: "მჟავების დამატება",
        description: "გამოთვალეთ მჟავების დამატება ღვინოს კორექტირებისთვის",
      },
      fining: {
        name: "დამწმენდი აგენტები",
        description: "გამოთვალეთ დამწმენდი აგენტების დამატება",
      },
      sulfur: {
      ...
      nutrients: {
        name: "საკვები ნივთიერებები & სტაბილიზატორები",
    ...
    calculators: {
      ...
      deacidification: { name: "დეაციდიფიკაცია", description: "გამოთვალეთ დეაციდიფიკაციის მოთხოვნები" },
      bentonite: { name: "ბენტონიტი", description: "გამოთვალეთ ბენტონიტის დამატება" },
      carbon: { name: "ნახშირბადი", description: "გამოთვალეთ აქტივირებული ნახშირის დამატება" },
      pvpp: { name: "PVPP", description: "გამოთვალეთ PVPP დამატება" },
      tannin: { name: "ტანინი", description: "გამოთვალეთ ტანინის დამატება" },
      "fining-trial": { name: "დამწმენდი ტესტი", description: "გამოთვალეთ დამწმენდი საცდელი ტესტები" },
